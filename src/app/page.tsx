...
export default function Home() {
  return (
    <>
      ...
      <div className="relative w-full pt-[50%] h-auto bg-[url('/assets/images/general/banner-home.jpg')] bg-auto bg-no-repeat bg-center my-20">
        <div className="absolute top-0 left-0 mx-auto py-10 text-white">
          <div>
          (DỊCH VỤ CỐT LÕI)
          </div>
        </div>
